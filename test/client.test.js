...
describe('POST /api/clients', () => {
  ...
  describe('Validation', () => {
    ...
    test('should validate name field', async () => {
      const testCases = [
        ...
        { name: 'A', field: 'name', message: 'at least 2 characters' },
        { name: 'A'.repeat(101), field: 'name', message: 'cannot exceed 100 characters' }
      ];
  ...
  describe('Error Handling', () => {
    test('should handle server errors gracefully', async () => {
      // Mock database error by providing invalid ObjectId
      jest.spyOn(require('../models/Client'), 'create').mockRejectedValueOnce(
      ...
      require('../models/Client').create.mockRestore();
    });
  });
});
  .send({
...
expectValidationError(response, testCase.field, testCase.message);
      }
    });
